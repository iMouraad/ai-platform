...
export const RegisterForm = () => {
  ...
  return (
    <div className="mx-auto flex w-full flex-col justify-center space-y-12 lg:w-[650px]">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 bg-white dark:bg-zinc-950 p-7 md:p-8 rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 shadow-2xl shadow-blue-500/5 max-w-[600px] mx-auto">
