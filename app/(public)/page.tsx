...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-zinc-50 dark:bg-zinc-950 overflow-hidden">
      ...
      <section className="container mx-auto px-6 pb-40 pt-16 lg:pt-24 relative z-10">
        ...
        <div className="mt-20 flex justify-center">
          <a 
            href="/directory" 
            className="group inline-flex items-center gap-3 px-10 py-5 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-black font-outfit uppercase tracking-widest text-[10px] rounded-2xl hover:bg-blue-600 dark:hover:bg-blue-600 hover:text-white dark:hover:text-white transition-all shadow-2xl active:scale-95"
          >
