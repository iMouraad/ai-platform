...
export default function LoginPage() {
  return (
    <div className="relative min-h-screen flex flex-col lg:flex-row bg-white dark:bg-zinc-950">
      {/* Visual Section (Left) */}
      <div className="relative hidden lg:flex lg:w-1/2 flex-col bg-zinc-900 p-16 text-white overflow-hidden">
        ...
        <div className="relative z-20 mt-auto max-w-lg">
          ...
          <blockquote className="space-y-6">
            <p className="text-4xl font-black font-outfit leading-[1.1] tracking-tighter uppercase italic">
              &ldquo;La inteligencia artificial no es el futuro, es el hoy. Domínala o deja que otros lo hagan.&rdquo;
            </p>
            <footer className="flex items-center gap-4">
              <div className="h-10 w-10 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center font-bold text-blue-500">DS</div>
              <div className="flex flex-col">
                <span className="text-sm font-black uppercase tracking-widest">David Silva</span>
                <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Senior Architect @ TechGlobal</span>
              </div>
            </footer>
          </blockquote>
        </div>
